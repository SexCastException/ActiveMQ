 ...
 * @date 2021/1/5 0:09
 */
public class JMSPersistentProducer {
    // ActiveMQ服务地址
    public static final String ACTIVEMQ_URL = "tcp://192.168.64.129:61616";
    // 消息队列名称
    public static final String QUEUE_NAME = "persistent-queue";
...
//        producer.setDeliveryMode(DeliveryMode.PERSISTENT);
        ...
        for (int i = 0; i < 3; i++) {
            // 7.创建消息
            TextMessage textMessage = session.createTextMessage("msg" + i + ":hello world for persistent message.");
            // 8.将消息发送到MQ
